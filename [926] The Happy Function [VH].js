...
Creates a loop that executes a specified statement until the test condition evaluates to false. The condition is evaluated after executing the statement, resulting in t …
___________________________
___________________________
Happy Numbers
http://www.numbersaplenty.com/set/happy_number/
Let us define a function s(n), for n>0, which gives the sum of the squares of the digits of n, so, for example, s(37)=3^2+7^2=58. If we start from a number n and we …
___________________________
___________________________
